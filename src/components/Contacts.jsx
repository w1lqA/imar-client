        ...
        <div className="xl:col-span-1 flex flex-col justify-center px-16 space-y-12 py-12 bg-[#6484CD]">
          ...
          <ContactForm emailType={emailType}/>
            ...
            <div className="xl:col-span-1">
                <div className='bg-[#2A2A2A] py-8 px-24'>
